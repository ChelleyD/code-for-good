...
function Donate() {
  const Orginisation = [
    ...
    },
    {
      ...
      pictures: TeamSea,
      note:
        "Team Seas, stylized as #TeamSeas, is an international collaborative fundraiser project run" +
    ...
    },
    {
      ...
      pictures: Team350,
      note:
        "350.org is an international environmental organization addressing the climate crisis. Its stated goal is to end the use of fossil fuels" +
  ...
  return (
    ...
    >
      <Typography className="donate-heading" variant="h3" style={{}}>
        <h3>
